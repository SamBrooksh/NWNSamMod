...
/*
    ...
    Adding some NWNX functionality to it
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if (GetModuleSwitchValue(MODULE_SWITCH_USE_XP2_RESTSYSTEM) == TRUE)
    {
        ...
        */
        ...
        {
            NWNX_Events_SignalEvent(SM_REST_EVENT_STARTED, oPC);
